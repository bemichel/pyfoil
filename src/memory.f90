...
subroutine grid_allocation(grid)
  ...
  integer imax, jmax
  print *,"in subroutine grid_allocation"
...
!=============================================================================80
!
! Deallocate things in the surf
!
!=============================================================================80
subroutine surf_deallocation(surf)

  Use vardef, only : airfoil_surface_type

  type(airfoil_surface_type), intent(inout) :: surf
  print *,"in subroutine surf_deallocation"

  deallocate(surf%x)
  deallocate(surf%y)

end subroutine surf_deallocation
...
subroutine grid_deallocation(grid)
  ...
  type(srf_grid_type), intent(inout) :: grid
  print *,"in subroutine grid_deallocation"
