...
C       write(*,*) 'PANGEN: XNEW = ',XNEW
C       write(*,*) 'PANGEN: YNEW = ',YNEW
C       write(*,*) 'PANGEN: NPAN = ',NPAN
C       write(*,*) 'PANGEN: XBIN = ',XBIN
C       write(*,*) 'PANGEN: YBIN = ',YBIN
C       write(*,*) 'PANGEN: NB   = ',NB
C       write(*,*) 'PANGEN: CVPAR   = ',CVPAR
C       write(*,*) 'PANGEN: CTERAT  = ',CTERAT
C       write(*,*) 'PANGEN: CTRRAT  = ',CTRRAT
C       write(*,*) 'PANGEN: XSREF1  = ',XSREF1
C       write(*,*) 'PANGEN: XSREF2  = ',XSREF2
C       write(*,*) 'PANGEN: XPREF1  = ',XPREF1
C       write(*,*) 'PANGEN: XPREF2  = ',XPREF2
